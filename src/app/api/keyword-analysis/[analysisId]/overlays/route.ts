/**
 * Legacy analysis overlay route.
 *
 * Compatibility entrypoint for /api/keyword-analysis/[analysisId]/overlays.
 * New code should use /api/analyses/[analysisId]/overlays.
 */
