 ...
 */
export function isPriceDataPointArray(value: unknown): value is PriceDataPoint[] {
 ...
 */
export function isTrendsDataPointArray(value: unknown): value is TrendsDataPoint[] {
 ...
 */
export function isYahooFinancePriceData(value: unknown): value is YahooFinancePriceData {
  if (typeof value !== 'object' || value === null) return false;
  const obj = value as Record<string, unknown>;
  return (
 ...
 */
export function isYahooFinanceHistoricalData(value: unknown): value is YahooFinanceHistoricalData {
  if (typeof value !== 'object' || value === null) return false;
  const obj = value as Record<string, unknown>;
  return (
 ...
 */
export function isSerpAPIGoogleTrendsResponse(value: unknown): value is SerpAPIGoogleTrendsResponse {
  if (typeof value !== 'object' || value === null) return false;
  const obj = value as Record<string, unknown>;
  return (
    (obj.search_metadata === undefined || typeof obj.search_metadata === 'object') &&
    (obj.interest_over_time === undefined || typeof obj.interest_over_time === 'object') &&
...
export function isProgressState(value: unknown): value is ProgressState {
  if (typeof value !== 'object' || value === null) return false;
  const obj = value as Record<string, unknown>;
  const validStages = ['idle', 'fetching-price', 'fetching-trends', 'calculating', 'saving', 'complete', 'error'];
  return (
...
export function parseSearchRecordRaw(raw: SearchRecordRaw): SearchRecord {
  try {
    ...
    throw new Error(`Failed to parse SearchRecord JSON: ${error instanceof Error ? error.message : 'Unknown error'}`);
  }
}
